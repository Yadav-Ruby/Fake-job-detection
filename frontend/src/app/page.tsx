    ...
    <div className="relative min-h-screen bg-cyber-bg overflow-hidden">
      ...
      <section className="relative px-6 pt-24 pb-20 md:pt-36 md:pb-28 max-w-7xl mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/admin"
              className="flex items-center space-x-2 w-full sm:w-auto justify-center rounded-xl border border-cyber-purple/20 bg-cyber-purple/5 px-8 py-4 font-bold text-cyber-purple hover:text-cyber-cyan transition-colors"
            >
