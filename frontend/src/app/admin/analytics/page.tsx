...
export default function AdminAnalyticsPage() {
  ...
  // Mock True vs False positives
  const accuracyData = [
    { month: 'Jan', TruePositives: 45, FalsePositives: 2 },
    { month: 'Feb', TruePositives: 60, FalsePositives: 3 },
    { month: 'Mar', TruePositives: 85, FalsePositives: 1 },
    { month: 'Apr', TruePositives: 110, FalsePositives: 4 },
    { month: 'May', TruePositives: 140, FalsePositives: 2 },
    { month: 'Jun', TruePositives: 195, FalsePositives: 2 }
  ];

  // Scans workload by day of week
  const loadData = [
    { day: 'Mon', URLScans: 120, TextScans: 85, ScreenshotScans: 45 },
    { day: 'Tue', URLScans: 145, TextScans: 95, ScreenshotScans: 60 },
    { day: 'Wed', URLScans: 180, TextScans: 110, ScreenshotScans: 75 },
    { day: 'Thu', URLScans: 160, TextScans: 90, ScreenshotScans: 50 },
    { day: 'Fri', URLScans: 210, TextScans: 130, ScreenshotScans: 95 },
    { day: 'Sat', URLScans: 95, TextScans: 60, ScreenshotScans: 30 },
    { day: 'Sun', URLScans: 115, TextScans: 75, ScreenshotScans: 40 }
  ];

  // Threat Category counts
  const categoryData = [
    { name: 'Advance Fee Checks', value: 34, color: '#f43f5e' },
    { name: 'Telegram Task Fraud', value: 48, color: '#6366f1' },
    { name: 'Phishing Listings', value: 25, color: '#00f0ff' },
    { name: 'Unverified Vacancies', value: 12, color: '#f59e0b' }
  ];
